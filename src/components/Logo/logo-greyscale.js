  ...
  return (
    <svg  width={props.size + 'px'} height={props.size + 'px'} viewBox="0 0 276 565" version="1.1">
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="logo" transform="translate(-503.000000, -138.000000)" fill-rule="nonzero">
                <g id="logo-greyscale" transform="translate(521.000000, 157.000000)">
                    <g id="Rectangle">
                        <g id="Mask" stroke="#EEEEEE" stroke-width="36.8">
                            <path d="M120.397351,527.20121 L120.397351,0" id="Path-2" stroke-linecap="round"></path>
                            <path d="M1.58940397,420.962179 L0.794701987,45.5310136" id="Path-2-Copy-2" stroke-linecap="round"></path>
                            <path d="M239.602649,420.962179 L239.602649,45.5310136" id="Path-2-Copy" stroke-linecap="round"></path>
